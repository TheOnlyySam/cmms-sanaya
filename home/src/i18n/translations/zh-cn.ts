const locale = {
  ...
  pricing_1: {
    ...
    title: "价格",
    description:
      "SyncShield CMMS 灵活的定价计划。在我们的开源 CMMS 的云端版本和自托管版本之间进行选择，以优化您的维护业务。",
  },
  get_started: "开始使用",
  ...
  overview_1: {
    description: "SyncShield CMMS 是一款免费、开源的 CMMS，用于管理工单、预防性维护、资产和设施。立即优化您的维护业务。",
    keywords:
      "CMMS, 计算机化维护管理系统, EAM, 企业资产管理, 开源 CMMS, 免费维护软件, 工单管理, 预防性维护, 资产跟踪, 设施管理, 维护跟踪软件, 设备维护, SyncShield CMMS",
  },
};
