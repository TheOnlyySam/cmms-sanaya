const deJSON = {
  ...
  'free_cmms.title': 'SyncShield Kostenlose CMMS-Software | Keine Kreditkarte erforderlich',
  ...
  'overview.description':
    'SyncShield CMMS ist ein kostenloses Open-Source-CMMS zur Verwaltung von Arbeitsaufträgen, vorbeugender Wartung, Anlagen und Einrichtungen. Optimieren Sie noch heute Ihre Wartungsarbeiten.',
  'overview.keywords':
    'CMMS, computergestütztes wartungsmanagementsystem, EAM, enterprise asset management, open-source-cmms, kostenlose wartungssoftware, arbeitsauftragsverwaltung, vorbeugende wartung, anlagenverfolgung, facility management, wartungsverfolgungssoftware, gerätewartung, SyncShield CMMS',
  'pricing.title': 'Preise - SyncShield CMMS',
  'pricing.description':
    'Flexible Preispläne für SyncShield CMMS. Wählen Sie zwischen Cloud- und selbstgehosteten Versionen unseres Open-Source-CMMS, um Ihre Wartungsarbeiten zu optimieren.',
