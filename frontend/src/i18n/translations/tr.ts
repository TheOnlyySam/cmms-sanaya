const trJSON = {
  ...
  'free_cmms.title': 'SyncShield Ücretsiz CMMS Yazılımı | Kredi kartı gerekmez',
  ...
  'overview.description':
    'SyncShield CMMS, iş emirlerini, önleyici bakımı, varlıkları ve tesisleri yönetmek için ücretsiz, açık kaynaklı bir CMMS\'dir. Bakım operasyonlarınızı bugün kolaylaştırın.',
  'overview.keywords':
    'CMMS, bilgisayarlı bakım yönetim sistemi, EAM, kurumsal varlık yönetimi, açık kaynaklı CMMS, ücretsiz bakım yazılımı, iş emri yönetimi, önleyici bakım, varlık takibi, tesis yönetimi, bakım takip yazılımı, ekipman bakımı, SyncShield CMMS',
  'pricing.title': 'Fiyatlandırma - SyncShield CMMS',
  'pricing.description':
    'SyncShield CMMS için esnek fiyatlandırma planları. Bakım operasyonlarınızı optimize etmek için açık kaynaklı CMMS\'mizin Bulut ve Kendi Sunucunuzda Barındırılan sürümleri arasından seçim yapın.',
