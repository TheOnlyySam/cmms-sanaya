const plJSON = {
  ...
  'free_cmms.title': 'SyncShield Darmowe Oprogramowanie CMMS | Karta kredytowa nie jest wymagana',
  ...
  'overview.description':
    'SyncShield CMMS to darmowy system CMMS o otwartym kodzie źródłowym do zarządzania zleceniami pracy, konserwacją zapobiegawczą, zasobami i obiektami. Usprawnij swoje operacje konserwacyjne już dziś.',
  'overview.keywords':
    'CMMS, komputerowy system zarządzania konserwacją, EAM, zarządzanie majątkiem przedsiębiorstwa, cmms open source, darmowe oprogramowanie do konserwacji, zarządzanie zleceniami pracy, konserwacja zapobiegawcza, śledzenie zasobów, zarządzanie obiektami, oprogramowanie do śledzenia konserwacji, konserwacja sprzętu, SyncShield CMMS',
  'pricing.title': 'Cennik - SyncShield CMMS',
  'pricing.description':
    'Elastyczne plany cenowe dla SyncShield CMMS. Wybierz między wersją w chmurze a wersją samodzielnie hostowaną naszego CMMS typu open source, aby zoptymalizować swoje operacje konserwacyjne.',
