const ptBRJSON = {
  ...
  'free_cmms.title': 'Software CMMS Grátis SyncShield | Sem necessidade de cartão de crédito',
  ...
  'overview.description':
    'O SyncShield CMMS é um CMMS gratuito e de código aberto para gerenciar ordens de serviço, manutenção preventiva, ativos e instalações. Simplifique suas operações de manutenção hoje mesmo.',
  'overview.keywords':
    'CMMS, sistema informatizado de gestão de manutenção, EAM, gestão de ativos empresariais, cmms de código aberto, software de manutenção gratuito, gestão de ordens de serviço, manutenção preventiva, rastreamento de ativos, gestão de instalações, software de rastreamento de manutenção, manutenção de equipamentos, SyncShield CMMS',
  'pricing.title': 'Preços - SyncShield CMMS',
  'pricing.description':
    'Planos de preços flexíveis para o SyncShield CMMS. Escolha entre as versões Cloud e Self-Hosted do nosso CMMS de código aberto para otimizar suas operações de manutenção.',
