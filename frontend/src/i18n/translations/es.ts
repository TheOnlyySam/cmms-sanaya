const esJSON = {
  ...
  'free_cmms.title':
    'Software GMAO Gratis SyncShield | No se requiere tarjeta de crédito',
  ...
  'overview.description':
    'SyncShield CMMS es un GMAO gratuito y de código abierto para gestionar órdenes de trabajo, mantenimiento preventivo, activos e instalaciones. Optimice sus operaciones de mantenimiento hoy.',
  'overview.keywords':
    'GMAO, sistema de gestión de mantenimiento computarizado, EAM, gestión de activos empresariales, gmao de código abierto, software de mantenimiento gratis, gestión de órdenes de trabajo, mantenimiento preventivo, seguimiento de activos, gestión de instalaciones, software de seguimiento de mantenimiento, mantenimiento de equipos, SyncShield CMMS',
  'pricing.title': 'Precios - SyncShield CMMS',
  'pricing.description':
    'Planes de precios flexibles para SyncShield CMMS. Elija entre las versiones en la nube y autoalojadas de nuestro GMAO de código abierto para optimizar sus operaciones de mantenimiento.',
